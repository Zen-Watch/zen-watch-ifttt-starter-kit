...
// Dynamic chose the input parameters from the payload 
...
function invoke_action() {
    ...
    const payload = {
        "params": {
            // Headers are the headers that you want to pass to your web2 server
            // You can add any number of headers here
            // It should be an array of objects with key and value
            "headers": [
                {
                    "key": "X-Api-Key",
                    "value": "123"
            ...
            // This is the method that you want to use to call your web2 server
            // If GET is used, body will be added as query params to the URL
            // Anything else will be sent as a JSON body
            "method": "GET",
            // These are the parameters that you want to pass to your web2 server
            // You can add any number of parameters here
            // They need to be available in the payload object
            "params": [
                "from",
                "to",
                "value"
            ],
            // This is the URL that you want to call
            "url": "https://example.com/api/endpoint"
        },
        "from": "0x123...",
        "to": "0x456...",
    ...
    dynamic_fetch(zenwatch, payload).then(() => {
